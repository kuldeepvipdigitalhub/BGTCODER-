...
if(isset($_SESSION['user'])) { // check if user is logged in
  ...
  echo '<a href="logout.php"class="logout-btn">LOGOUT</li>';
  ?>
  <style>
...
<!-- section of study-->
    ...
    <div class="html">
        ...
        <br>
        <a href="htmlintroduction.php"> <p>Learn more</p></a> 
        </h3>
        </a>
    </div>
    </section>
    ...
    <div class="css">
        <h1>CSS</h1>
        <br>
        <h3><p> CASE CADING STYLESHEET</p> 
        <br>
        <a href="css_introduction.php"> <p>Learn more</p></a> 
        </h3>
        </a>
    </div>
    </section>
    ...
    <div class="js">
        ...
        <br>
        <a href="js_introduction.php"> <p>Learn more</p></a> 
        </h3>
        </a>
    </div>
    </section>
    ...
    <div class="PHP">
        ...
        <br>
        <p><a href="php_introduction.php">Learn more
    ...
    <div class="JAVA">
        ...
        <br>
       <a href="java_introduction.php"> <p>Learn more</p></a> 
        <br>
        </h3>
        </a>
    </div>
    ...
    <div class="PYTHON">
        ...
        <br>
        <a href="python_introduction.php"> <p>Learn more</p></a> 
        </h3>
        </a>
    </div>
    </section>
        ...
        <div class="container">
            <div class="content-section">
                ...
                <div class="content">
                    ...
                    <div class="button">
                        <a href="http://localhost/bgtcoder/htmlintroduction.php">Read more</a>
                    </div>
                </div>
                <div class="social">
            ...
            <div class="row">
                ...
                <div class="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="quizform.php">Quiz</a></li><br>
                     ...
                     <div class="footer-col">
                        ...
                        <ul>
                            ...
                            <br>
                            <li><a href="tream_condition.php"> Terms&Conditions</a></li>
                      </ul>
                     </div>
                     <div class="footer-col">
                        <h4>USEFULL LINK</h4>
                        ...
                        <div class="sub">
                        <a href="AdminL.php"><h5>@Copyright group 4 GPC BALAGHAT</h5></a>                
                        </div>
    </footer>
    </section>
</body>
